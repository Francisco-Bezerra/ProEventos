...
export class EventoDetalheComponent implements OnInit {
  ...
  //     },
  //     (error: any) => {
  //       this.toastr.error('Erro ao tetnar carregar lotes', 'Erro');
  //       console.error(error);
  //     }
  ...
  public mudarValorData(value: Date, indice: number): void{
    this.lotes.value[indice].dataInicio = value.toDateString();
  }
  ...
  public uploadImagem(): void{
    ...
    this.eventoService.postUpload(this.eventoId, this.file).subscribe(
      () => {
        this.carregarEvento();
        this.toastr.success('Imagem atulizada com sucesso.', 'Sucesso!');
      },
      (error: any) => {
